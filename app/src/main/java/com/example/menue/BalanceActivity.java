...
import com.example.menue.Adapters.BalanceAdapter;
...
public class BalanceActivity extends AppCompatActivity {
    ...
    private static final String NOTIFICATIONS_LIST_URL= "http://192.168.1.178:8080/mosaver/get_account_balance.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new BalanceAdapter(this,mData);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < users.length(); i++) {
                                ...
                                BalanceModel balanceModel = new BalanceModel(id, fullname, account, balance);




                                mData.add(balanceModel);
                               /* error_message.setVisibility(View.GONE);*/

                            }
                            adapter = new BalanceAdapter(BalanceActivity.this, mData);
                            recyclerView.setAdapter(adapter);
...
//                            login.setVisibility(View.VISIBLE);
                            Toast.makeText(BalanceActivity.this, "failed to save........ "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        loading.dismiss();
//                        login.setVisibility(View.VISIBLE);
                        Toast.makeText(BalanceActivity.this, "Saving continues to  failllllllllllll"+error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
